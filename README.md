...
> ⚠️OpenAI has deprecated all Engine-based APIs. See [Deprecated Endpoints](https://github.com/fallbackwjj/openai-java#deprecated-endpoints) below for more info.
